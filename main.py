...
class EcomApp:
    ...
    @staticmethod
    def place_order(order_processor, order_id, customer_id, shipping_address):
        ...
        try:
            success = order_processor.placeOrder(order_id, customer_id, products_quantity_map, shipping_address)
            if success:
    ...
    def main():
        ...
        while True:
            ...
            if choice == "1":
                ...
                # products_quantity_map = {} 
                customer = Customer(customer_id, "", "", "") 
                EcomApp.place_order(order_processor, order_id, customer, shipping_address)
            elif choice == "7":
                # View Customer Order
